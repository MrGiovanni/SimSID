import torch
from dataloader.dataloader_siim import SIIM
...
class Config(BaseConfig):
    ...
    def __init__(self):
        ...
        self.data_root = '/mnt/data0/yixiao/Pneumothorax_segmentation'
        self.train_dataset = SIIM(
            self.data_root,
            phase='train',
