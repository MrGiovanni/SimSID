...
sys.path.insert(0, '..')
import torch
from dataloader.dataloader_nih import NIHChestXray
...
class Config(BaseConfig):
    ...
    def __init__(self):
        ...
        self.scheduler_args = dict(T_max=30, eta_min=self.lr*0.1)
        ...
        self.scheduler_args_d = dict(T_max=30, eta_min=self.lr*0.2)
        ...
        self.data_root = '/mnt/data0/yixiao/nih_chestxray'
        self.train_dataset = NIHChestXray(
            self.data_root,
            phase='train',
        ...
        self.test_dataset = NIHChestXray(
            self.data_root,
            phase='test',
            img_size=(self.img_size, self.img_size),
            normalize_tanh=self.normalize_tanh,
            test_with_bbox=False
        )
