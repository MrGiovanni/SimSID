import torch
from dataloader.dataloader_node import Node21
...
class Config(BaseConfig):
    ...
    def __init__(self):
        ...
        # model
        self.img_size = 256
        self.normalize_tanh = False    # if True, images are normalized to [-1, 1] and model output layer is tanh.
        ...
        self.data_root = '/mnt/data0/yixiao/node21/cxr_images/proccessed_data'
        self.train_dataset = Node21(
            self.data_root,
            phase='train',
