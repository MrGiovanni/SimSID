...
class MemoryMatrixBlockConfig():
    ...
    shrink_thres = -1    # if < 0, no gumbel softmax
    mask_ratio = 1.0
...
class Config(BaseConfig):
    ...
    def __init__(self):
        ...
        self.level = 4
        self.dist = False
        self.ops = ['none', 'none', 'none', 'none']    # ['concat', 'concat', 'none', 'none']
        self.decoder_memory = ['none', 'none', 'none', 'none']
        self.use_memory_inpaint_block = False
        self.teacher_stop_gradient = False
